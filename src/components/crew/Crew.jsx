...
@media (max-width: 1115px) {
  height: 100vh;
  overflow: hidden;
  background: url('/crewfolder/background-crew-tablet.jpg') linear-gradient(to bottom, rgba(248,80,50,1) 0%, rgba(43, 31, 30, 0.92) 8%, rgba(241,111,92,0.54) 46%, rgba(50, 36, 35, 0.01) 100%);
          ...
          <div className='btn-crew'>
            {
              theCrew.map((member, index) => (
                <button className={index === value ? 'active' : undefined} key={index} onClick={() => setValue(index)} />
              ))
            }
          </div>
        </article>
